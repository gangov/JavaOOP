...
The child derives from the person. Every person has a name, and an age. Your task is to model the application.
The Person class also have getters for the fields.
Create a Child class that inherits Person and has the same public constructor definition. However, do not copy the code
